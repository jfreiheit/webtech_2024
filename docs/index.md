...
??? hint "Vorbereitung Vorlesung Bootstrap"
	...
	=== "02_bs_grid.html"
		...
		<body>
		    <main class="container pt-5 ">
		        <h2>Virtuelle Spaltenanzahl in einer Zeile ist 12</h2>
		        <div class="row">
...
??? hint "Vorbereitung Vorlesung JavaScript"
	...
	=== "04_async.html"
		...
		*/
		...
		let z = function (callback) {
		    ...
		    callback();
		    console.log("Ausgabe der Funktion z - nach Aufruf von callback");
		}
		...
		function testPromises(file) {
		    makeRequest(file)               // resolve-Fall
		    .then( response => {
		...
		async function fetchTest() {
		    ...
		    try {
		        let response = await fetch('https://jsonplaceholder.typicode.com/posts1');
		        console.log(response);
		        if (!response.ok) {
		        ...
		        console.log("body : ", body)
		        //let value = body.origin;
		        //console.log(value)
		    }catch(error) {
		        console.log("kein fetch moeglich ", error)
		    }
...
!!! question "Mindestanforderungen"
	...
	* In beiden Repositories (Frontend und Backend) **muss** es jeweils in mind. 5 Wochen jeweils mehrere Commits geben!
	...
	Nach Abgabe vereinbaren wir ein Präsenz-Meeting, in dem Sie mir Ihre Anwendung nochmal zeigen können und ich Ihnen Fragen zu Ihrem Code stellen werde. Ist keine Prüfung, sondern eher ein fachliches Gespräch.  
